    ...
    *,
    ...
    candidates = {
        "nondegenerate_mass_spectrum": {
            ...
            "target_spectrum_status": "THREE_DISTINCT_MASS_SQUARED_EIGENVALUES" if mass_nondegenerate else "DEGENERATE_OR_UNRESOLVED",
            "paired_source_operator_M_I_status": "UNRESOLVED",
            "required_contract": "M^2 J = J M_I",
            "conditional_stabilizer": "U(1)^3" if mass_nondegenerate else "UNRESOLVED",
            "conditional_stabilizer_dimension": mass_dim,
            "conditional_projective_dimension": mass_projective_dim,
            "verdict": "CONDITIONAL_REDUCTION_REQUIRES_SOURCE_OPERATOR" if mass_nondegenerate else "NO_REDUCTION_CERTIFIED",
        },
        "symbolic_resonant_hamiltonian": {
            "source_ref": str(resonance_source_ref),
            "current_object": "H_sT=sum_n omega_n |S_n><S_n| with omega_n determined from R(S_n,I)",
            "three_mode_neutrino_spectral_matching": "UNRESOLVED",
            "candidate_role": "POSSIBLE_SOURCE_SIDE_M_I_IF_A_THREE_MODE_SLICE_AND_SPECTRAL_MATCHING_ARE_DERIVED",
            "verdict": "STRUCTURALLY_MATCHED_SOURCE_CLASS_BUT_NO_NEUTRINO_BINDING",
        },
    ...
    theorem = {
        ...
        "premise_0": "a paired source operator M_I is fixed and J obeys M^2 J = J M_I",
        "premise_1": "M^2 and M_I have matched nondegenerate spectra, so ambiguity between valid intertwiners is D=diag(e^{i theta_1},e^{i theta_2},e^{i theta_3})",
    ...
    core = {
        ...
        "strongest_current_reduction": "NONE_BEYOND_U(3)_WITHOUT_PAIRED_SOURCE_OPERATOR",
        "strongest_conditional_reduction": "U(3)->U(1)^3_IF_M_I_IS_SOURCE_BOUND_AND_M^2_J=J_M_I",
        ...
        "belzebub_verdict": "CURRENT_J_REMAINS_U3_UNRESOLVED__PAIRED_NONDEGENERATE_SOURCE_OPERATOR_WOULD_REDUCE_TO_U1^3__CONNECTED_SECOND_INVARIANT_WOULD_THEN_IDENTIFY_PROJECTIVELY",
